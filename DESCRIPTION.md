...
5. Read the [wiki](https://github.com/kenshineto/kenshinshideandseek/blob/main/.wiki/2-Setup.md) for in game setup instructions

**Reporting Bugs**
Instead of leaving a review with the error message, please report issues [here](https://github.com/kenshineto/kenshinshideandseek/issues).

**Contributing**
Please send PRs [here](https://github.com/kenshineto/kenshinshideandseek/pulls) and make sure to read the CONTRIBUTING.md file in the repository.
...
- Total message localization that allows players to change any message in the plugin to whatever they want. English localizations have been premade, but still can be altered if wished.
